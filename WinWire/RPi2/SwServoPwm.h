...
#define CHANNEL_WIDTH_MAX		(CHANNEL_NUM_STEPS - 1)
        ...
        private:
            ...
            bool InitPrephirals()
            {
                ...
                WRITE_REGISTER_ULONG(&BcmPwm::Inst().Reg()->Control, 0);
                MicroDelay(10);

                if (!BcmCm::Inst().StopPwmClock())
                    return false;
